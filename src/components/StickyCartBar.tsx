      ...
      <div className="max-w-4xl mx-auto flex items-center justify-between gap-2.5 sm:gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          <button
            ...
            className={`p-2 rounded-full border transition-all flex items-center gap-1 cursor-pointer active:scale-95 ${
              confirmClear
        ...
        <button
          type="button"
          onClick={onOpenCart}
          className="flex-1 flex items-center justify-between bg-gold-gradient hover:bg-gold-gradient-hover text-[#0B0B0C] px-4 sm:px-6 py-2 sm:py-2.5 rounded-full shadow-lg transition-all duration-300 active:scale-[0.98] group cursor-pointer"
        >
