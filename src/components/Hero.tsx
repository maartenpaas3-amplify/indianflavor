...
export const Hero: React.FC<HeroProps> = ({ lang = 'fr' }) => {
  ...
  return (
    <section className="relative overflow-hidden py-5 sm:py-7 bg-[#8F2D2E]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center flex flex-col items-center justify-center">
        {/* Kicker Eyebrow */}
        <span className="text-[#c9a35c] text-xs sm:text-sm uppercase tracking-[0.2em] sm:tracking-[0.25em] font-serif font-extrabold block mb-0.5 sm:mb-1 drop-shadow">
          {kicker}
        </span>
        ...
        <div className="flex items-center justify-center gap-2.5 my-2 sm:my-2.5 w-[130px] sm:w-[180px] pointer-events-none select-none" aria-hidden="true">
          <div className="h-[1px] flex-1 bg-gradient-to-r from-transparent via-[#c9a35c]/60 to-[#c9a35c]" />
          <span className="text-[#c9a35c] text-[9px] sm:text-[11px] leading-none">◆</span>
          <div className="h-[1px] flex-1 bg-gradient-to-l from-transparent via-[#c9a35c]/60 to-[#c9a35c]" />
        </div>
